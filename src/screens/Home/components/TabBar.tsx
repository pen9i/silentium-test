...
const Tabs = ['Latest Articles', 'Recent Stories', 'Top Reads'];
...
export const TabBar: FC<Props> = ({ onPress, activeIndex }) => {
	...
	return (
		<View style={components.tabParentContainer}>
			<View style={components.tabBarContainer}>
				{Tabs.map((tab, index) => (
					<TabBarButton
				...
				<Animated.View
					style={[components.tabIndicator, indicatorAnimatedStyle]}
				/>
			</View>
		</View>
	);
